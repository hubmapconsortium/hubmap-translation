...
search_api_app = importlib.import_module("app", "search-api/src")
...
# This search_api instance will be imported by wsgi.py when deployed with uWSGI server
application = search_api_app.SearchAPI(config, translator_module)
